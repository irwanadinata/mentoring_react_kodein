    ...
    <div className="fifthSectionContainer">
      <div className="fifthSectionLeft">
        ...
        <p className="fifthSectionLeftText">
          Every month, we shine spotlight on one saver,asking <br />
          them questions about their saving culture and how the <br />
          product is specifically hellping them how they spend <br />
          and save for future responsibilities
        </p>
        <p className="fifthSectionLeftTextMobile">
          Every month, we shine spotlight on <br />
          one saver,asking them questions <br />
          about their saving culture and how the <br />
          product is specifically hellping them <br />
          how they spend and save for future <br />
          responsibilities
        </p>
