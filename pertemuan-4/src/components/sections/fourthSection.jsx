    ...
    <div className="fourthSectionContainer">
      ...
      <div className="fourthSectionRight">
        ...
        <p className="fourthSectionText">
          Invest securely and confidentialy on the go. Grow your <br />
          money confidently by investing on pre-vetted investment <br />
          opportunities
        </p>
        <p className="fourthSectionTextMobile">
          Invest securely and confidentialy on the go. <br />
          Grow your money confidently by investing on <br />
