      ...
      <div className="eighthSectionContainer">
        <div className="footerDescription">
          <div className="footerPart">
            <img src="assets/logo.png" alt="" srcset="" className="footerLogo" />
          ...
          <div>
            <p className="footerText">
              <span className="footerLaslesVpn">LaslesVPN</span> is a private
          ...
          <div className="sosmedLogo">
            <div>
              <img src="assets/fb.png" alt="" srcset="" className="sosmedLogo" />
            </div>
            <div>
              <img src="assets/tw.png" alt="" srcset="" className="sosmedLogo" />
            </div>
            <div>
              <img
